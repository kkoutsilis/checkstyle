...
public class UnusedTryResourceShouldBeUnnamedCheck extends AbstractCheck {
    ...
    public void visitToken(DetailAST ast) {
        if (ast.getType() == TokenTypes.LITERAL_TRY) {
            ...
            if (resourceSpec != null) {
                final TryResourceDetails tryParameter = new TryResourceDetails(resourceSpec);
                tryResources.push(tryParameter);
            }
        }
        else if (isTryParameterIdentifierCandidate(ast) && !isLeftHandOfAssignment(ast)) {
     ...
     */
    private static boolean isTryParameterIdentifierCandidate(DetailAST identifierAst) {
